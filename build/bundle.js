var app = (function () {
    ...
    // (57:8) {#each materials as material (material.id)}
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			thead.innerHTML = `<tr class="svelte-beq4f7"><th>Material</th> 
            <th>Price</th> 
            <th></th></tr>`;
    			...
    			t8 = text(t8_value);
    			attr(td1, "colspan", "2");
    			attr(tr1, "class", "svelte-beq4f7");
    			attr(table, "class", "primary svelte-beq4f7");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "float-right svelte-193wqul");
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(main, "class", "svelte-1ro91er");
    		},
    		m(target, anchor) {
